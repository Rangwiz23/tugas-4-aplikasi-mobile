...
void editData(){
var url = Uri.parse('http://localhost/tugaspengembanganaplikasimobile4/tugasaplikasimobile/tugas4pengembanganaplikasimobile/update.php'); //update api calling
...
@override
void initState() {
title = TextEditingController(text: widget.list[widget.index]['title']); //setting up the values in textediting control
