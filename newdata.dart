...
void addData(){
var url = Uri.parse('http://localhost/tugaspengembanganaplikasimobile4/tugasaplikasimobile/tugas4pengembanganaplikasimobile/create.php'); //Inserting Api Calling
